macro "FMI supported > MIPs for PSFs FMI" {
...
S=fromCharCode(92);
path="C:"+S+"Users"+S+"Public"+S+"LogFileImageJ.txt";
...
// _______________________Get info on the setup at FMI_______________________
...
MainName=date+"_"+microscope+"_"+MA+"x_"+NA+"_Optovar "+optovar;
zVoxel=200;
...
MainName=MainName+"_FWHMa_"+d2s(FWHMa,0)+"nm_FWHMl_"+d2s(FWHMl,0)+"nm";
run("Images to Stack");
rename(MainName);
...
//________Save at FMI__________________________
